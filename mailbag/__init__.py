...
mailbagit_args.add_argument("-d","--derivatives", required=True, help="output type(s) MBOX/PST/EML/PDF/WARC", nargs='+')
...
mailbagit_options.add_argument("-h", "--no-headers", help="will not include email headers in mailbag.csv", action='store_true')
